  ...
  return (
    <div className='max-h-screen'>
      ...
      <div className='absolute'>
        <img className="h-screen object-contain" src={BG_URL} alt='login' />
      </div>
      <form onSubmit={(e) => e.preventDefault()} className='p-12 bg-black absolute w-full md:w-3/12 my-36 mx-auto right-0 left-0 text-white bg-opacity-80 rounded-lg'>
